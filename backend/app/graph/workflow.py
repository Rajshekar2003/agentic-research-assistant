...
Week 2 Day 8 — graph now has 2 nodes: planner and searcher.
  START → planner → searcher → END

  Day 9 will add fact_checker between searcher and writer.
  Day 10 splits searcher's LLM call into a dedicated writer node.
  Day 11 adds critic with conditional edge back to writer.
